// src/middlewares/groupement/validateInput.js

/**
 * Validation middleware specifically for Groupement management operations
 */
...
// Groupement-specific validators
export const validateGroupementCreate = createValidator({
  name: [rules.required, rules.string, rules.minLength(1), rules.maxLength(255)],
  active: [rules.boolean]
});

export const validateGroupementUpdate = createValidator({
  name: [rules.string, rules.minLength(1), rules.maxLength(255)],
  active: [rules.boolean]
});

export const validateGroupementSearch = createValidator({
