// src/middlewares/succursale/validateInput.js

/**
 * Validation middleware specifically for Succursale management operations
 */
...
// Succursale-specific validators
export const validateSuccursaleCreate = createValidator({
  name: [rules.required, rules.string, rules.minLength(1), rules.maxLength(255)],
  active: [rules.boolean]
});

export const validateSuccursaleUpdate = createValidator({
  name: [rules.string, rules.minLength(1), rules.maxLength(255)],
  active: [rules.boolean]
});

export const validateSuccursaleSearch = createValidator({
  searchTerm: [rules.required, rules.string, rules.minLength(1), rules.maxLength(100)]
});

// For route parameters
export const validateSuccursaleId = (req, res, next) => {
...
export const validateSuccursaleQuery = (req, res, next) => {
