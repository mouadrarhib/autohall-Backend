// src/middlewares/typeobjectif/validateInput.js
...
export const validateTypeObjectifCreate = createValidator({
  name: [rules.required, rules.string, rules.minLength(1), rules.maxLength(100)]
});

export const validateTypeObjectifUpdate = createValidator({
  name: [rules.required, rules.string, rules.minLength(1), rules.maxLength(100)]
});

export const validateTypeObjectifId = (req, res, next) => {
